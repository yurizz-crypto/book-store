...
class User extends Authenticatable implements MustVerifyEmail, Auditable
{
    ...
    {
        return [
            // FIX: Removed the unassigned string fields
    ...
    /**
     * CLEAN CODE: Modern Laravel Attribute syntax (Usage: $user->full_name)
     */
    ...
    /**
     * NEW: Encapsulated business logic to clean up the ReviewController
     */
