    ...
    <form method="post" action="{{ route('addresses.update') }}" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                <x-input-label for="street_address" :value="__('Street Address')" class="font-semibold" />
                <x-text-input id="street_address" name="street_address" type="text" class="mt-1 block w-full border-gray-200 focus:ring-indigo-500 rounded-xl" :value="old('street_address', $address->street_address ?? '')" required />
            </div>
